    ...
    <div className="mx-auto flex flex-col items-center gap-10 px-5 py-5 font-semibold text-black lg:w-4/5 xl:px-20">
      ...
      <section className="w-full space-y-3 text-xl">
        ...
        <ol className="w-full translate-x-7 list-disc">
          <li>
            Se aplica anestesia local en el área afectada para adormecerla.
          </li>
          <li>Se utiliza el cauterizador para quemar la verruga.</li>
      ...
      <section className="w-full space-y-3 text-xl">
        <h2 className="w-full text-2xl font-bold text-red-600">
          ¿Cómo se sabe si es una verruga o un lunar?
        </h2>
