    ...
    <div className="mx-auto flex flex-col items-center gap-10 px-5 py-5 font-semibold text-black lg:w-4/5 xl:px-20">
      ...
      <div className="flex w-full flex-col lg:flex-row">
        ...
        <div className="w-full space-y-8 bg-black/60 p-3 text-white lg:my-10 lg:w-2/3 lg:p-8">
          ...
          <p className="text-2xl font-light lg:text-3xl">
            Nuestros profesionales capacitados ofrecen procedimientos seguros y
      ...
      <section className="w-full space-y-3 text-xl">
        ...
        <ul className="w-full translate-x-7 list-disc">
          ...
          <li>Avoidar cafeína y alcohol 24 horas antes del procedimiento.</li>
        </ul>
      </section>
      <section className="w-full space-y-3 text-xl">
        <h2 className="w-full text-2xl font-bold text-red-600">
        ...
        <ul className="w-full translate-x-7 list-disc">
          ...
          <li>Aplicar pomada antibiótica según las indicaciones.</li>
          <li>Avoidar rascar el área.</li>
      ...
      <section className="w-full space-y-3 text-xl">
        ...
        <p className="w-full list-disc">
          Los lunares cancerosos suelen tener las siguientes características:
        </p>
        <ul className="w-full translate-x-7 list-disc">
          <li>Asimetría.</li>
      ...
      <section className="w-full space-y-3 text-xl">
        ...
        <p className="w-full list-disc">
          El procedimiento generalmente lleva unos minutos.
        </p>
      </section>
      <section className="w-full space-y-3 text-xl">
        <h2 className="w-full text-2xl font-bold text-red-600">
