    ...
    <div className="mx-auto flex flex-col items-center gap-10 px-5 py-5 font-semibold text-black lg:w-4/5 xl:px-20">
      ...
      <div className="mx-auto flex flex-col items-center gap-10 px-5 py-5 font-semibold text-black lg:w-4/5 xl:px-20">
        ...
        <section className="w-full space-y-3 text-xl">
          ...
          <p className="w-full list-disc">
            Si tus resultados de análisis son anormales, tu médico te informará
            y te explicará qué significa para tu salud.
          </p>
        </section>
        ...
        <p className="w-full list-disc">
          ...
          afecciones. Se pueden realizar para:
        </p>
        ...
        <ul className="w-full translate-x-7 list-disc">
          ...
          <li>
            Hormonas: para evaluar la función tiroidea, la fertilidad, etc.
          </li>
          <li>
        ...
        <section className="w-full space-y-3 text-xl">
          ...
          <p className="w-full list-disc">
            La anestesia local adormece la zona, por lo que el procedimiento no
            es doloroso.
          </p>
        </section>
        ...
        <section className="w-full space-y-3 text-xl">
          <div>
            ...
            <br></br>
            <ul className="w-full translate-x-7 list-disc">
              <li>Consume alimentos integrales y no procesados.</li>
