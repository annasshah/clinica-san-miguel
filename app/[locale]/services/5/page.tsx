  ...
  return locale === "es" ? (
    <div className="mx-auto flex flex-col items-center gap-10 px-5 py-5 font-semibold text-black lg:w-4/5 xl:px-20">
      ...
      <div className="flex w-full flex-col lg:flex-row">
        ...
        <div className="w-full space-y-8 bg-black/60 p-3 text-white lg:my-10 lg:w-2/3 lg:p-8">
          ...
          <p className="text-2xl font-light lg:text-3xl">
            Atención médica compasiva y amigable para los más pequeños,
            cubriendo chequeos de rutina, vacunaciones e intervenciones
            oportunas para un desarrollo infantil óptimo.
          </p>
        </div>
      </div>
      <p className="w-full text-2xl">
        Clínica San Miguel: Atención Pediátrica de Calidad para Sus Niños
      </p>
      <section className="w-full space-y-3 text-xl">
        ...
        <ol className="w-full">
          Si la fiebre de su hijo es superior a 102°F (39°C), debe darle a su
          hijo acetaminofén o ibuprofeno. También puede darle un baño tibio o
          aplicar compresas frías en su frente. Si la fiebre persiste o si su
          hijo tiene otros síntomas, como dificultad para respirar, convulsiones
          o letargo, debe buscar atención médica de inmediato.
        </ol>
      </section>
      <section className="w-full space-y-3 text-xl">
        <h2 className="w-full text-2xl font-bold text-red-600">
        ...
        <ol className="w-full">
          La mejor manera de prevenir la gripe es vacunarse anualmente. También
          es importante lavarse las manos con frecuencia, cubrirse la boca y la
          nariz al toser o estornudar, y evitar el contacto con personas
          enfermas.
        </ol>
      </section>
      <section className="w-full space-y-3 text-xl">
        ...
        <ol className="w-full">
          Si su hijo tiene alergias, es importante identificar los
          desencadenantes y evitarlos. También puede usar medicamentos para
          aliviar los síntomas de la alergia. Palabras clave:
        </ol>
      ...
      <section>
        <p>
          ...
          Clínica Pediátrica de Houston, atención médica para niños, diagnóstico
          y tratamiento de enfermedades, pruebas de laboratorio, atención
          especializada, gripe, estreptococo, gripe, alergias en niños,
    ...
    <div className="mx-auto flex flex-col items-center gap-10 px-5 py-5 font-semibold text-black lg:w-4/5 xl:px-20">
      ...
      <section>
        <p>
          ...
          treatment of diseases, laboratory tests, specialized care, flu ,
          strep, flu, allergies in children, frequently asked questions
        </p>
      </section>
    </div>
  );
