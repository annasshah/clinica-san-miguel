...
const Home = () => (
  <div className="mx-auto flex flex-col items-center gap-10 px-5 py-5 font-semibold text-black lg:w-4/5 xl:px-20">
    <h1 className="text-center text-6xl text-red-600">Immigration Medical Exams</h1>
    <div className="flex w-full flex-col lg:flex-row">
      ...
      <div className="w-full space-y-8 bg-black/60 p-3 text-white lg:my-10 lg:w-2/3 lg:p-8">
        ...
        Immigration Medical Exams,Comprehensive exams meeting immigration standards, conducted by certified professionals.        </p>
      </div>
    </div>
    ...
    Health benefits
      ...
      <ul className="w-full translate-x-7 list-disc">
        ...
        <li>Improvement of quality of life</li> </ul>
      <h2 className="w-full text-2xl font-bold text-red-600">
    ...
    <section className="w-full space-y-3 text-xl">
      ...
      <p className="w-full list-disc">
      If your test results are abnormal, your doctor will tell you and explain what it means for your health.
      </p>
    </section>
...
Blood tests are a fundamental tool for the diagnosis and monitoring of a wide variety of diseases and conditions. They can be performed to:
      </p>
      ...
      <ul className="w-full translate-x-7 list-disc">
        ...
        <li>Cholesterol and triglycerides: to assess the risk of heart disease .</li>
        ...
        <li>Proteins:  to evaluate kidney and liver function, etc.</li> </ul>
